...
public class MessageGenerator {
	...
	public static String generateInvitationBody(Invitation invitation) {
		...
		String manageLink = "If you want to manage your invitations click here: http://localhost:8080/pa036/my-account\n";
		String joinLink = "If you want to join this event click here: http://localhost:8080/pa036/accept/" + invitation.getId() + "\n\n";
	...
	public static String generateEventEditBody(String sportsmanName, Event event) {
		...
		String link = "If you want to review changes just click here: http://localhost:8080/pa036/events/" + event.getId() + "\n\n";
	...
	public static String generateEventCancelBody(String sportsmanName, Event event) {
		...
		String link = "If you want to choose from some other events just click here: http://localhost:8080/pa036/events\n\n";
